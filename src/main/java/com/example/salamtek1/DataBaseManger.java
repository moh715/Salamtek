...
class DatabaseManager {
    ...
    private HashMap<String, Officer> officers = new HashMap<>();
    private HashMap<String, Hub> hubs = new HashMap<>();
    private HashMap<String, Vehicle> vehicles = new HashMap<>();
    private HashMap<String, Accident> accidents = new HashMap<>();
    private HashMap<String, Payment> payments = new HashMap<>();
    private HashMap<String, String> licensePlateToVehicle = new HashMap<>();
